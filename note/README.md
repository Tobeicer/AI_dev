...
3. Chrome:控制谷歌浏览器。(9)  
4. Browser: 网页调试插件，支持在浏览器中调试代码，查看DOM元素、网络请求等。(8.5)  
5. Figma: 需求或代码转成figma设计稿，也能创建图表和设计系统。(8) 
6. Remotion: 程序化视频，支持从图片序列创建视频。(7.5)  
7. Canva:图形设计、海报制作、社交媒体素材生成。(7.5)  
8. HyperFrames by HeyGen:自然语言打造动态页面效果。(7)  
9. Build Web Apps: 快速开发网页。   
10. Vercel: 部署网页到Vercel，支持自动部署和监控。  
11. Spreadsheets: 能生成带公式、格式、图表和分析结果的表格。  
12. Windsor.ai:用于进行营销数据分析。  
13. BioRender:创建专业的科学插图和图标。  
14. product design:高级ui审美
