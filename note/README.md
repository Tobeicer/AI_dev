...
9. Code Simpliffer:代码精简与重构，消除冗余、提升可维护性。(7)
10. Webapp Testing:Web应用自动化测试，端到端UI交互和兼容性检测。(7)
11. PPTX:原生PowerPoint文件生成，支持图表、模板和多媒体。(7)
12. antivo skills:对抗验证技能集，检测和修正AI输出的幻觉与偏差。(7)
13. gsap-skills:官方级动画代码，时间轴控制，滚动动画，路径动画，ScrollTrigger等各种复杂动画生成，用于交互式网页开发。(6)
14. supercloud framework:多云统一部署框架，简化跨平台运维。(6)
15. minimax cues:MiniMax提示词模板库，优化多模态生成效果。(6)
16. impeccable:前端skill，提升前端页面质量和高级质感。(5)
17. taste-skill:前端skill。提升前端设计品味。(5)
18. amsp-skills:高德地图skill，提升地图功能和交互体验(含API)。(3)
